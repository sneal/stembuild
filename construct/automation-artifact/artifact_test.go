...
import (
	...
	artifact "github.com/pivotal-cf-experimental/stembuild/construct/automation-artifact"
...
var _ = Describe("Artifact", func() {
	...
	Describe("DownloadAutomationArtifact", func() {

		Context("an existing version of the artifact is specified", func() {
			It("downloads the artifact and puts it in the working dir", func() {

				_, err := os.Stat("StemcellAutomation.zip")
				Expect(os.IsNotExist(err)).To(BeTrue())

				err = artifact.DownloadAutomationArtifact("0.3", tmpDir)
